 ...
 *
 * The inner workings of this camera are obfuscated, so that students of the TU Vienna's introduction to computer
...
public:
     ...
     */
    VklCamera(float fov, float aspect, float near, float far);
